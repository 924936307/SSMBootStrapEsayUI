            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom">
                        <form role="form" action="${pageContext.request.contextPath}/manager/login" method="post" class="login-form">
   ...
   function pwdOnclick() {
    ...
    function loginJudge() {
        ...
        if (userName == null || userName == "") {
            document.getElementById("login_prompt").innerHTML = "用户名不能为空！";
            return;
        }
        if (password == null || password == "") {
            document.getElementById("login_prompt").innerHTML = "密码不能为空！";
            return;
        }
        $.post("${pageContext.request.contextPath}/manager/login", {
                'userName': userName,
                'password': password
            },
            function (result) {
                ...
                if (result.success) {
                    ...
                    document.getElementById("login_prompt").innerHTML = "用户名或密码错误！请重新登录！！";
                }
            }
        );
    }
